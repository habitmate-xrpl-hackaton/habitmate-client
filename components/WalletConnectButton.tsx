...
export function WalletConnectButton({ 
  ...
  const MetaMaskIcon = () => (
    <svg width="20" height="20" viewBox="0 0 318.6 318.6" style={{ flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        ...
        <polygon fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" points="238.3,206.8 211.8,247.4 268.5,262.6 284.8,207.7 "/>
        <polygon fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" points="33.9,207.7 50.1,262.6 106.8,247.4 80.3,206.8 "/>
      ...
      <g>
        <polygon fill="#D7C1B3" stroke="#D7C1B3" strokeLinecap="round" strokeLinejoin="round" points="211.8,247.4 177.9,230.9 180.6,253 180.3,262.2 "/>
        <polygon fill="#D7C1B3" stroke="#D7C1B3" strokeLinecap="round" strokeLinejoin="round" points="106.8,247.4 138.3,262.2 138.1,253 140.6,230.9 "/>
      </g>
      ...
      <g>
        ...
        <polygon fill="#CD6116" stroke="#CD6116" strokeLinecap="round" strokeLinejoin="round" points="207.1,206.8 211.8,247.4 238.3,207.7 "/>
      ...
      <polygon fill="#C0AD9E" stroke="#C0AD9E" strokeLinecap="round" strokeLinejoin="round" points="180.3,262.2 180.6,253 178.1,250.8 140.4,250.8 138.1,253 138.3,262.2 106.8,247.4 117.8,256.4 140.1,271.9 178.4,271.9 200.8,256.4 211.8,247.4 "/>
  ...
  if (isConnected && address) {
    if (variant === 'label') {
      return (
        <div className="flex items-center gap-2 bg-[#d5ece0] px-3 py-2 rounded-xl">
          <MetaMaskIcon />
    ...
    return (
      <Button
        ...
        className="w-full border-[#3ba935] text-[#3ba935] hover:bg-[#3ba935] hover:text-white rounded-xl flex items-center justify-center gap-2"
      >
        <MetaMaskIcon />
        <span>Wallet Connected {formatAddress(address)}</span>
      </Button>
    );
  }
  ...
  return (
    <Button
      onClick={onConnect}
      className="w-full bg-[#3843ff] text-white hover:bg-[#6b73ff] rounded-xl flex items-center justify-center gap-2"
    >
      <MetaMaskIcon />
