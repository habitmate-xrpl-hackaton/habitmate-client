    ...
    <SheetPortal>
      ...
      <div className="fixed inset-0 z-50 flex justify-center">
        <SheetPrimitive.Content
          ...
          className={cn(
            "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 w-full max-w-md mx-auto p-4",
            side === "right" &&
